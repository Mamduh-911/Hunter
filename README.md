...
**HUNTER**
 ...
 هي أداة مفتوحة المصدر مطورة بلغة بايثون، تهدف إلى مساعدة الباحثين الأمنيين ومختبري الاختراق في إجراء عمليات الاستكشاف الأمني، وتحليل تطبيقات الويب، وجمع المعلومات، واكتشاف المؤشرات المحتملة للثغرات بأساليب آمنة وغير مؤثرة على الأنظمة، مع التركيز على الكشف والتحليل دون تنفيذ أي استغلال آلي
